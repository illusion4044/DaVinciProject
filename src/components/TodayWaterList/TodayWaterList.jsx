...
// export default function TodayWaterList() {
//   const [isOpenDeleteModal, setIsOpenDeleteModal] = useState(false);
//   const [selectedPortion, setSelectedPortion] = useState(null); // To track the selected portion for delete/edit
...
//                     <svg
//                       className={css.iconPencil}
//                       onClick={() => openEditModal(portion)} // Pass portion to edit modal
//                     >
//                       <use href={`${sprite}#icon-pencil-square`}></use>
//                     </svg>
...
//                     <svg
//                       className={css.iconTrash}
//                       onClick={() => openDeleteModal(portion)} // Pass portion to delete modal
//                     >
//                       <use href={`${sprite}#icon-trash`}></use>
//                     </svg>
//                   </div>
//                   {isEditModalOpen && selectedPortion?._id === portion._id && (
//                     <TodayListModal
//                       onClose={() => dispatch(closeTodayModal())}
